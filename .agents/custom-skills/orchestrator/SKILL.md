...
> Read and follow `<firstmate-home>/.agents/custom-skills/orchestrator/CONTRACT.md` and `<firstmate-home>/.agents/custom-skills/program-orchestration/SKILL.md`. They are your contract for this whole programme.
