...
> Read and follow `<firstmate-home>/.agents/roles/orchestrator/contract/CONTRACT.md` and `<firstmate-home>/.agents/skills/program-orchestration/SKILL.md`. They are your contract for this whole programme.
