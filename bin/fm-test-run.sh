...
family_for_basename() {
  case "$1" in
    ...
    fm-operational-input.test.sh|fm-orchestrator-skill.test.sh|fm-pi-primary-types.test.sh|fm-planner-skill.test.sh|\
    ...
    fm-spawn-dispatch-profile.test.sh|fm-spawn-worktree-settle.test.sh|fm-spawn-available-skills.test.sh)
      printf '%s\n' backend-dispatch
      ;;
