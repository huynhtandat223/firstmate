...
custom-skills/       planner and orchestrator child-role contracts with their custom supporting material and per-role skill catalogs; committed; loaded by absolute path, not by harness skill discovery
