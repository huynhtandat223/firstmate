...
state/               volatile runtime signals; gitignored
  ...
  .hash-* .count-* .stale-* .stale-since-* .paused-* .wedge-escalations-* .work-evidence-* .seen-* .hb-surfaced-* .last-* .heartbeat-streak   watcher internals; never touch
