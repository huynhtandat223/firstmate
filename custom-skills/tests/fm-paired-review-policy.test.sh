...
assert_grep 'fm-pair-compose.sh' "$PARENT" "parent does not own composition"
assert_no_grep 'fm-pair-compose.sh' "$DRIVER" "driver owns composition details"
assert_no_grep 'fm-pair-compose.sh' "$NAVIGATOR" "navigator owns composition details"
