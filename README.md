...
- A verified primary agent harness: Claude Code, Grok, Pi, `pi-signed`, Codex, OpenCode, Cursor Agent CLI, or Antigravity CLI (`agy`).
...
Antigravity CLI (`agy`) is also a verified primary and crew harness; its task lifecycle and launch facts live in the harness-adapters skill.
